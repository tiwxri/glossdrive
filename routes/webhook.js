...
function getTimeBasedGreeting() {
  ...
  const { handleMessageFlow: _handleMessageFlow, handlePostbackFlow: _handlePostbackFlow } = require('../utils/flow'); // keep for consistency
  ...
  // ✅ FIX: Avoid redefining `handleMessageFlow` from import
